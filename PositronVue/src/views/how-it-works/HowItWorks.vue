            ...
            <v-container>
                ...
                <v-container grid-list-xl>
                    <v-fade-transition leave-absolute>
                        <v-layout wrap align-center :key="1" v-if="levelTab == 0">
                            <v-flex xs12 sm6>
                        ...
                        <v-layout wrap align-center :key="2" v-else-if="levelTab == 1">
                            <v-flex xs12 sm6>
                        ...
                        <v-layout wrap align-center :key="3" v-else-if="levelTab == 2">
                            <v-flex xs12 sm6>
                        ...
                        <v-layout wrap align-center :key="4" v-else-if="levelTab == 3">
                            <v-flex xs12 sm6>
                        ...
                        <v-layout wrap align-center :key="5" v-else-if="levelTab == 4">
                            <v-flex xs12 sm6>
                        ...
                        <v-layout wrap align-center :key="6" v-else-if="levelTab == 5">
                            <v-flex xs12 sm6>
                        ...
                        <v-layout wrap align-center :key="7" v-else-if="levelTab == 6">
                            <v-flex xs12 sm6>
                        ...
                        <v-layout wrap align-center :key="8" v-else>
                            <v-flex xs12 sm6>
